...
import imgline from "./css/live.png"
            ...
            >
              {navMenus.list.map((nm) => {
                return nm.name.toLowerCase().trim() === "courses" ? (
                  <div className="wrap-nav-icon"> 
                  { nm.image? <img src={nm.image} style={{width:"2vw" ,height:"2vw"}} />: <img style={{display:"none"}}/>
...
<h1 className="nav-hot">{nm.highLightText}</h1>
</div>
                  <NavDropdownMenu
                    title="Courses"
                  ...
                  <Nav.Item as="li" key={nm._id}>
                    <div className="wrap-nav-icon">
                    { nm.image? <img src={nm.image}  />: <img style={{display:"none"}}/>

}
                      <div className="">
                    {/* <h1 className="nav-hot">ENROLLEMENT OPEN</h1> */}
                    <div className="nav-h1">
              ...
              >
                <Nav.Link as={Link} className="position-relative" style={{marginTop:"33%"}} to="/cart">
                  {cart && cart.items && cart.items != 0 ? (
                    <span
                      className="badge badge-warning badge-sm position-absolute"
                      style={{ top: "-3px", right: "-3px" }}
