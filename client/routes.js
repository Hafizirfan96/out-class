...
// const ChooseWhatever = loadable(() => import("./pages/ChooseWhatever"), { ssr: true });
...
const QuizBank = loadable(() => import("./pages/QuizBank"), {
  ssr: true,
});
const ForumPage = loadable(() => import("./pages/ForumPage"), { ssr: true });

const NotFound = loadable(() => import("./pages/NotFound"), { ssr: true });
const ChooseWhatever = loadable(() => import("./pages/ChooseWhatever"), {
  ssr: true,
});
const NewQuizBank =loadable(() => import("./components/NewQuizBank"), {
  ssr: false,
});
const StartQuiz =loadable(() => import("./components/StartQuiz"), {
  ssr: false,
});
const QuizResult =loadable(() => import("./components/QuizResult"), {
  ssr: false,
});
export default [
