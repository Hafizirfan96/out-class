...
const MyCourses = (props) => {
  ...
  const renderCourses = () => {
    ...
    return filteredCourses.map((course) => {
      return (
        <>
        <div className="col-sm-6 col-md-3" key={course._id} style={{marginBottom:"2%"}}>
  ...
  return (
    <div className="courses_page">
      ...
      <div className="wrap-Self-study-heading" >
        <h1>Get Instant Access to Lessons Taught by Pakistan’s Top Teachers
With Self-Study Courses, you can select any topic at any time.
</h1>
       </div>
      <div className="container">
        <div className="py-5" >
      ...
      <div className="position-relative" style={{ minHeight: "200px" }}>
       ...
       <div className="wrap-self-study-title">
        <h1>Enroll in Self Study Lessons
</h1>
        <p>Choose from self-paced courses below
</p>
       </div>
          <div className="container-selfstudy py-5" >
            <h1 className="C-b-sub">Courses by Subject</h1>
      ...
      <div className="choose-course-banner df">
        <div style={{width:"40%"}}>
          <h1 style={{
            fontWeight:"400",
            fontSize:"2.5vw"
          }}>
          Or try out our <strong style={{color:"red"}}>
          LIVE LESSONS
            </strong> 
<h1 style={{
            fontWeight:"400",
            fontSize:"2.5vw"
          }}> some other text string here</h1>

          </h1>
        </div>
        <div style={{width:"20%" , marginTop:"2%"}}>
          <Link className="live-lessons-btn">
          Live Lessons
