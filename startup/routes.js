...
const quizBankQARouter = require("../controllers/api/cms/quizBankQA");
const quizBankRouter = require("../controllers/api/cms/quizBank");
const quizBankRecordRouter = require("../controllers/api/cms/quizBankRecord");
...
module.exports = function (app) {
  ...
  app.use("/api/cms/footer_links", footerLinksRouter);
  app.use("/api/cms/quiz_bank_qa", quizBankQARouter);
  app.use("/api/cms/quiz_bank", quizBankRouter);
  app.use("/api/cms/quiz_bank_record", quizBankRecordRouter);
