...
import { createFooterLink } from "../../../store/api/footerThree";
...
class CreateEditFooterThree extends Component {
  state = {
    pages: [],
    form: {
      name: "",
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Footer Section Three Link</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(CreateEditFooterThree);
