...
import {
  ...
  removeFooterLink,
} from "../../../store/api/footerThree";
import { setFooterLinks } from "../../../store/cms/footerThree";
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/footer_three/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Footer Secton Three Links</h2>
                <Link
                  to={basePath + "/cms/footer_three/add"}
...
export default connect(mapStateToProps, mapDispatchToprops)(FooterThree);
