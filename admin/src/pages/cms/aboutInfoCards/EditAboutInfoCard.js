          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit About Info Card</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  editAboutInfoCard: (params) => dispatch(editAboutInfoCard(params)),
  getAbouInfoCard: (params) => dispatch(getAbouInfoCard(params)),
});
