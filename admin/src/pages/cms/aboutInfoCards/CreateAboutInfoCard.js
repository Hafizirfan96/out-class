...
import { createAboutInfoCard } from "../../../store/api/aboutInfoCards";
const schema = {
...
class CreateInfoCard extends Component {
  ...
  onFormSubmit = (e) => {
    ...
    this.props.createAboutInfoCard({
      body: formData,
      onSuccess: () => {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create About Info Card</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  createAboutInfoCard: (params) => dispatch(createAboutInfoCard(params)),
});
