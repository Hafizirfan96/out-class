...
const schema = {
  heading4: Joi.string().optional().allow(""),
  text4: Joi.string().optional().allow(""),
 
};

class EditRevissionTest extends Component {
  state = {
    id: "",
    pages: [],
    form: {
  ...
  loadSlider = (id) => {
    ...
    this.props.getHomeMiddle({
      ...
      onSuccess: (res) => {
        ...
        const imagePreview = res.data.data.image4 || "";
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Revision & Test Section</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditRevissionTest);
