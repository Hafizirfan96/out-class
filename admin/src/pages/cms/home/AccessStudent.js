...
const schema = {
  heading8: Joi.string().optional().allow(""),
  text8: Joi.string().optional().allow(""),
  ...
  loadSlider = (id) => {
    ...
    this.props.getHomeMiddle({
      ...
      onSuccess: (res) => {
        ...
        const imagePreview = res.data.data.image8 || "";
        ...
        <div className="row">
          ...
          <div className="col-12">
            <Input
              ...
              name="heading"
              onChange={(heading8) => {
                form.heading8 = heading8;
                errors.heading8 = "";
                this.setState({ form, errors });
              }}
              value={form.heading8}
              error={errors.heading8}
            />
          </div>
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Access Student Section</h2>
              </div>
            </CardHeader>
