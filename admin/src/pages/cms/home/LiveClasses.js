...
const schema = {
  heading1: Joi.string().optional().allow(""),
...
class EditLiveClasses extends Component {
  state = {
    id: "",
    pages: [],
    form: {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Live Classes Section</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditLiveClasses);
