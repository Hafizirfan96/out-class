...
const schema = {
  heading5: Joi.string().optional().allow(""),
  text5: Joi.string().optional().allow(""),
  ...
  loadSlider = (id) => {
    ...
    this.props.getHomeMiddle({
      ...
      onSuccess: (res) => {
        ...
        const imagePreview = res.data.data.image5 || "";
        ...
        <div className="row">
          ...
          <div className="col-12">
            <Input
              ...
              name="heading"
              onChange={(heading5) => {
                form.heading5 = heading5;
                errors.heading5 = "";
                this.setState({ form, errors });
              }}
              value={form.heading5}
              error={errors.heading5}
            />
          </div>
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit 24/7 Section</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditQA);
