...
class EditSelfStudy extends Component {
  state = {
    id: "",
    pages: [],
    form: {
  ...
  loadSlider = (id) => {
    ...
    this.props.getHomeMiddle({
      ...
      onSuccess: (res) => {
        ...
        const imagePreview = res.data.data.image2 || "";
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Self Study Section</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditSelfStudy);
