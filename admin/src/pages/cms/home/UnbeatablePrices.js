...
import{editUnbeatablePrices,getUnbeatablePrices} from "../../../store/api/unbeatablePrices";
...
class EditUnbeatablePrices extends Component {
  state = {
    id: "",
    pages: [],
    form: {
  ...
  loadSlider = (id) => {
    ...
    this.props.getUnbeatablePrices({
      id,
      onSuccess: (res) => {
  ...
  onFormSubmit = (e) => {
    ...
    this.props.editUnbeatablePrices({
      id,
      body: formData,
      onEnd: () => {
        this.setState({ showLoader: false });
...
const mapDispatchToprops = (dispatch) => ({
  editUnbeatablePrices: (params) => dispatch(editUnbeatablePrices(params)),
  getUnbeatablePrices: (params) => dispatch(getUnbeatablePrices(params)),
  getPages: (params) => dispatch(getPages(params)),
});

export default connect(mapStateToProps, mapDispatchToprops)(EditUnbeatablePrices);
