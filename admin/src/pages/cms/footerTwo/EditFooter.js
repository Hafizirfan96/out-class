...
import { getFooterLink, editFooterLink } from "../../../store/api/footerTwo";
...
class EditFooterTwo extends Component {
  state = {
    pages: [],
    id: "",
    form: {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Footer Section Two Link</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditFooterTwo);
