...
import {
  ...
  removeFooterLink,
} from "../../../store/api/footerTwo";
import { setFooterLinks } from "../../../store/cms/footerTwo";
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/footer_two/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Footer Secton Two Links</h2>
                <Link
                  to={basePath + "/cms/footer_two/add"}
