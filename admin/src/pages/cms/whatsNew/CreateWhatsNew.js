...
class CreateWhatsNew extends Component {
  state = {
    pages: [],
    form: {
      heading: "",
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Whats New Slider</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(CreateWhatsNew);
