...
class EditStudentMaterialPage extends Component {
  state = {
    id: "",
    pages: [],
    form: {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Study Material Slider</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditStudentMaterialPage);
