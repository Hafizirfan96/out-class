...
class EditPopularCourses extends Component {
  state = {
    id: "",
    pages: [],
    form: {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Popular Courses</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(EditPopularCourses);
