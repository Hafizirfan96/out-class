          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Board</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  editWhyPageBoard: (params) => dispatch(editWhyPageBoard(params)),
  getWhyPageBoard: (params) => dispatch(getWhyPageBoard(params)),
});
