...
import { createWhyPageBoard } from "../../../store/api/whyPageBoards";
const schema = {
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Board</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  ...
  createWhyPageBoard: (params) => dispatch(createWhyPageBoard(params)),
});
