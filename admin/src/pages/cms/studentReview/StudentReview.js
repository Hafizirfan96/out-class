            ...
            return (
              <ListGroupItem className="rounded mb-1">
                <div className="clearfix">
                  <span>{`${item.heading} -> ${item.text}`}</span>
                  <Button
                    color="danger"
                    size="sm"
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/student_review/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Student Rating Slide</h2>
                <Link
                  to={basePath + "/cms/student_review/add"}
...
export default connect(mapStateToProps, mapDispatchToprops)(StudentReview);
