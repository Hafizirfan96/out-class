...
import { setStats } from "../../../store/cms/studyMaterial";
...
class QuizBank2 extends Component {
  state = {
    showLoader: false,
  };
  componentDidMount = () => {
    ...
    this.props.loadStats({id});
    const { list = [] } = this.props.stats;
    console.log("listss===", list.quizBankQA)
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/quiz-bank-card/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Quiz Topic</h2>
                <Link
                  to={basePath + "/cms/quiz-bank-card/add"}
...
export default connect(mapStateToProps, mapDispatchToprops)(QuizBank2);
