...
import { editTeamMember, getTeamMember } from "../../../store/api/teamMembers";
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Team Member</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  ...
  editTeamMember: (params) => dispatch(editTeamMember(params)),
  getTeamMember: (params) => dispatch(getTeamMember(params)),
});
