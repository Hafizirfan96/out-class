...
import { setStats } from "../../../store/cms/resultSlider";
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/result_slider/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Result Slide</h2>
                <Link
                  to={basePath + "/cms/result_slider/add"}
...
export default connect(mapStateToProps, mapDispatchToprops)(ResultSlider);
