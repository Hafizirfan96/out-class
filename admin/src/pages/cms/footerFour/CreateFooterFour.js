...
import { createFooterLink } from "../../../store/api/footerFour";
...
class CreateEditFooterFour extends Component {
  state = {
    pages: [],
    form: {
      name: "",
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Footer Section Four Link</h2>
              </div>
            </CardHeader>
...
export default connect(mapStateToProps, mapDispatchToprops)(CreateEditFooterFour);
