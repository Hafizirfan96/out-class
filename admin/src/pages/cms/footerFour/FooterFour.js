...
import {
  ...
  removeFooterLink,
} from "../../../store/api/footerFour";
import { setFooterLinks } from "../../../store/cms/footerFour";
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      ...
                      this.props.history.push(
                        basePath + "/cms/footer_four/" + item._id
                      );
                    }}
                  >
      ...
      <>
        ...
        <Container className="mt--7" fluid>
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Footer Secton Four Links</h2>
                <Link
                  to={basePath + "/cms/footer_four/add"}
...
export default connect(mapStateToProps, mapDispatchToprops)(FooterFour);
