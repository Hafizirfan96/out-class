...
import { getEvent, editEvent } from "../../store/api/events";
  ...
  loadEvent = (id) => {
    ...
    this.props.getEvent({
      ...
      onSuccess: (res) => {
        ...
        form.startDate = moment(res.data.data.startDate, "X").toDate();
        form.endDate = moment(res.data.data.endDate, "X").toDate();

        this.setState({ form, imagePreview: res.data.data.image });
      },
      onEnd: () => {
...
const mapDispatchToprops = (dispatch) => ({
  getEvent: (params) => dispatch(getEvent(params)),
  editEvent: (params) => dispatch(editEvent(params)),
});
