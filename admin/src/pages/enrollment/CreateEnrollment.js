        ...
        <div className="row">
          ...
          {/* <div className="col-12">
            <SearchSelect
              ...
              options={chaptersDropdownList}
              name="courses"
              isMulti={true}
              onChange={(e) => {
                if (!e) e = [];
                form.chapters = e.map((i) => i.value);

                console.log("Change ERR => ", form);
                errors.chapters = "";
                this.setState({ form, errors });
              }}
              value={chaptersDropdownList.filter((i) =>
                form.chapters.includes(i.value)
              )}
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Create Enrollment</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  ...
  createEnrollment: (params) => dispatch(createEnrollment(params)),
});
