...
import { editLanguage, getLanguage } from "../../store/api/languages";
...
const mapDispatchToprops = (dispatch) => ({
  editLanguage: (params) => dispatch(editLanguage(params)),

  getLanguage: (params) => dispatch(getLanguage(params)),
});
