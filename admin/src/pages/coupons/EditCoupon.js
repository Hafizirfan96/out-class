...
import { getCoupon, editCoupon } from "../../store/api/coupons";
  ...
  loadCourses = () => {
    ...
    this.props.getCoursesForDropdown({
      onSuccess: (res) => {
        ...
        console.log("courses for dropdown", courses);
    ...
    this.props.getCoupon({
      ...
      onSuccess: (res) => {
        ...
        const form = {
          ...
          referalEmails,
          reusabilityCount,
          validTill: moment(validTill, "X").toDate(),
          isActive,
        };
        this.setState({ form });
      },
          ...
          <div className="col-6">
            <MySelect
              ...
              onChange={(e) => {
                ...
                form.applicableTo = applicableTo || "category";
                form.category = "";
                form.course = "";
                errors.applicableTo = "";
                this.setState({ form, errors });
          ...
          <div className="col-6">
            ...
            <DatePicker
              ...
              onChange={(date) => {
                ...
                // const nd = moment(date).format("X");

                // console.log("ND =>", nd, parseInt(nd));
                form.validTill = date; //parseInt(nd);
                errors.validTill = "";
                this.setState({ form, errors });
              }}
          ...
          <Card className="shadow">
            <CardHeader>
              <div className="clearfix">
                <h2 className="mb-0 float-left">Edit Coupon</h2>
              </div>
            </CardHeader>
...
const mapDispatchToprops = (dispatch) => ({
  ...
  getCoupon: (params) => dispatch(getCoupon(params)),
  editCoupon: (params) => dispatch(editCoupon(params)),
});
