...
import {
  ...
  loadingNavbarMenus,
  deleteNavbarMenu,
} from "../../store/cms/navbar";

const path = "/cms/navbar";

export const loadNavbarMenus = ({
  body = {},
  onSuccess,
  onError,
  onEnd,
...
export const getNavbarMenu = ({ id = "", onSuccess, onError, onEnd } = {}) => {
  return async (dispatch, getState) => {
    dispatch(loadingNavbarMenus(true));
    try {
      //showing loader on ui
...
export const rearrangeNavMenus = ({
  body = {},
  onSuccess,
  onError,
  onEnd,
