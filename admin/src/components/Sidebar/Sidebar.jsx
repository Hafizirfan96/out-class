  ...
  state = {
    ...
    navItems: [
      ...
      },
      {
        ...
        link: "/cms/popular_courses",
      },
      
      {
        icon: "ni ni-money-coins text-pink",
        name: "Result Sliders",
        link: "/cms/result_slider",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Study Material Sliders",
        link: "/cms/study_material",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Whats New Sliders",
        link: "/cms/whats_new",
      },
      ...
      {
        icon: "ni ni-money-coins text-pink",
        name: "Live Classess Section",
        link: "/cms/live_classess",
      },
      
      {
        icon: "ni ni-money-coins text-pink",
        name: "Self Study Section",
        link: "/cms/self_study_section",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Quiz Bank Section",
        link: "/cms/quiz_bank",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Revision Section",
        link: "/cms/revission_test",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "24/7 Section",
      ...
      {
        icon: "ni ni-money-coins text-pink",
        name: "Study Plans Section",
        link: "/cms/study_plans",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Revision Notes Section",
        link: "/cms/revision_notes",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Access Student Section",
        link: "/cms/access_student",
      },
      
      {
        icon: "ni ni-money-coins text-pink",
        name: "Unbeatable Prices Section",
        link: "/cms/unbeatable_prices",
      },
     
      {
        icon: "ni ni-money-coins text-pink",
        name: "Student Stats Section",
        link: "/cms/student_stats",
      },
      ...
      {
        icon: "ni ni-money-coins text-pink",
        name: "Footer Two Links",
        link: "/cms/footer_two",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Footer Three Links",
        link: "/cms/footer_three",
      },
      {
        icon: "ni ni-money-coins text-pink",
        name: "Footer Four Links",
        link: "/cms/footer_four",
      },
