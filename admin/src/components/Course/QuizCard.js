    ...
    return (
      <Formik
        initialValues={{
          ...
          showInVideoTime: quiz.showInVideoTime || "00:00:00",
        }}
        validationSchema={Yup.object().shape({
          name: Yup.string().min(1).required(),
          type: Yup.string().min(1).required(),
          showInVideoTime: Yup.string().min(1).required(),
        })}
          ...
          return (
            <Form>
              <div className="row">
                ...
                {values.type === "video" && (
                  <div className="col-2">
                    <p className="mb-1">Quiz Pop Time</p>
                    {editMode ? (
                      <TimePicker
                        style={{
                          position: "relative",
                      ...
                      <Badge color="primary">{values.showInVideoTime}</Badge>
                    )}
                  </div>
                )}
