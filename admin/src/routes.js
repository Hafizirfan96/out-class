...
// import StudyPLans from "./pages/cms/home/StudyPLans";
...
const ShowLessons = lazy(() => import("./pages/courses/ShowLessons"));
...
///cms/common_data
//Popular courses
const PopularCourses = lazy(() => import("./pages/cms/popularCourses/PopularCourses"));
const CreatePopularCourses = lazy(() =>
  import("./pages/cms/popularCourses/CreatePopularCourses")
);
const EditPopularCourses = lazy(() =>
  import("./pages/cms/popularCourses/EditPopularCourses")
);
//Quiz bank
const QuizBank2 = lazy(() => import("./pages/cms/quizBank/QuizBank"));
const QuizCard2 = lazy(()=> import("./pages/cms/quizBank/QuizCard") );
const QuizMcqs = lazy(()=> import("./pages/cms/quizBank/QuizMcqs") );
const CreateQuizMcqs = lazy(()=> import("./pages/cms/quizBank/CreateQuizMcqs") );
const CreateQuizMcqs2 = lazy(()=> import("./pages/cms/quizBank/CreateQuizMcqs2") );
const EditQuizMcqs = lazy(()=> import("./pages/cms/quizBank/EditQuizMcqs") );

const CreateQuizBank = lazy(() =>
  import("./pages/cms/quizBank/CreateQuizBank")
);
const EditQuizBank = lazy(() =>
  import("./pages/cms/quizBank/EditQuizBank")
);
const EditQuizCard = lazy(() =>
  import("./pages/cms/quizBank/EditQuizCard")
);
const CreateQuizCard = lazy(() =>
  import("./pages/cms/quizBank/CreateQuizCard")
);
...
//Footer Links CMS Routes
const FooterTwo = lazy(() => import("./pages/cms/footerTwo/FooterTwo"));
const CreateFooterTwo = lazy(() =>
  import("./pages/cms/footerTwo/CreateFooterTwo")
);
const EditFooterTwo = lazy(() =>
  import("./pages/cms/footerTwo/EditFooter")
);
const Notification = lazy(() => import("./pages/cms/notification/Notification"));
const CreateNotification = lazy(() =>
  import("./pages/cms/notification/CreateNotification")
);
// const EditFooterTwo = lazy(() =>
//   import("./pages/cms/footerTwo/EditFooter")
// );
//Footer Links CMS Routes
const FooterThree = lazy(() => import("./pages/cms/footerThree/FooterThree"));
const CreateFooterThree = lazy(() =>
  import("./pages/cms/footerThree/CreateFooterThree")
);
const EditFooterThree = lazy(() =>
  import("./pages/cms/footerThree/EditFooterThree")
);
const FooterFour = lazy(() => import("./pages/cms/footerFour/FooterFour"));
const CreateFooterFour = lazy(() =>
  import("./pages/cms/footerFour/CreateFooterFour")
);
const EditFooterFour = lazy(() =>
  import("./pages/cms/footerFour/EditFooterFour")
);
...
// result slider
const ResultSlider = lazy(() => import("./pages/cms/resultSlider/ResultSlider"));
const EditResultSlider = lazy(() =>
  import("./pages/cms/resultSlider/EditResultSlider")
);
const CreateResultSlider = lazy(() =>
  import("./pages/cms/resultSlider/CreateResultslider")
);
// study slider
const StudyMaterial = lazy(() => import("./pages/cms/studyMaterial/StudyMaterial"));
const EditStudyMaterial = lazy(() =>
  import("./pages/cms/studyMaterial/EditStudentMaterial")
);
const CreateStudyMaterial = lazy(() =>
  import("./pages/cms/studyMaterial/CreateStudyMaterial")
);
// student material
const StudentReview = lazy(() => import("./pages/cms/studentReview/StudentReview"));
const EditStudentReview = lazy(() =>
  import("./pages/cms/studentReview/EditStudentReview")
);
const CreateStudentReview = lazy(() =>
  import("./pages/cms/studentReview/CreateStudentReview")
);
// whats new slider
const WhatsNew = lazy(() => import("./pages/cms/whatsNew/WhatsNew"));
const EditWhatsNew = lazy(() =>
  import("./pages/cms/whatsNew/EditWhatsNew")
);
const CreateWhatsNew = lazy(() =>
  import("./pages/cms/whatsNew/CreateWhatsNew")
);
...
const SelfStudy = lazy(() => import("./pages/cms/home/SelfStudy"));
const LiveClassess = lazy(() => import("./pages/cms/home/LiveClasses"));
const QuizBank = lazy(() => import("./pages/cms/home/QuizBank"));
const RevissionTest = lazy(() => import("./pages/cms/home/RevissionTest"));
const QA = lazy(() => import("./pages/cms/home/Q&A"));
const StudyPLans = lazy(() => import("./pages/cms/home/StudyPLans"));
const RivisionNotes = lazy(() => import("./pages/cms/home/RivisionNotes"));
const AccessStudent = lazy(() => import("./pages/cms/home/AccessStudent"));
const UnbeatablePrices = lazy(() => import("./pages/cms/home/UnbeatablePrices"));
const StudentStats = lazy(() => import("./pages/cms/home/StudentStats"));
...
export const authenticatedRoutes = [
  ...
  { path: "/courses/chapters_lessons/:id", component: ShowLessons },
...
//popular courses 
  { path: "/cms/popular_courses/add", component: CreatePopularCourses },
  { path: "/cms/popular_courses/:id", component: EditPopularCourses },
  { path: "/cms/popular_courses", component: PopularCourses },
  //quiz bank
  { path: "/cms/quiz-bank/add", component: CreateQuizBank },
  { path: "/cms/quiz-bank-card/add", component: CreateQuizCard },
  { path: "/cms/quiz-bank-card/:id", component: EditQuizCard },
  { path: "/cms/quiz-bank/:id", component: EditQuizBank },
  { path: "/cms/quiz-bank", component: QuizBank2 },
  { path: "/cms/quiz-card", component: QuizCard2 },
  { path: "/cms/quiz-Mcqs", component: QuizMcqs },
  { path: "/cms/quiz-Mcqs/add", component: CreateQuizMcqs },
  { path: "/cms/quiz-Mcqs2/add", component: CreateQuizMcqs2 },
  { path: "/cms/quiz-Mcqs/:id", component: EditQuizMcqs },
  ...
  { path: "/cms/footer_links", component: FooterLinks },
    //footer Two links
    { path: "/cms/footer_two/add", component: CreateFooterTwo },
    { path: "/cms/footer_two/:id", component: EditFooterTwo },
    { path: "/cms/footer_two", component: FooterTwo },
  //footer Three links
  { path: "/cms/footer_three/add", component: CreateFooterThree },
  { path: "/cms/footer_three/:id", component: EditFooterThree },
  { path: "/cms/footer_three", component: FooterThree },
  //footer Three links
  { path: "/cms/footer_four/add", component: CreateFooterFour },
  { path: "/cms/footer_four/:id", component: EditFooterFour },
  { path: "/cms/footer_four", component: FooterFour },
...
// result Slider
{ path: "/cms/result_slider/add", component: CreateResultSlider },
  { path: "/cms/result_slider/:id", component: EditResultSlider },
{ path: "/cms/result_slider", component: ResultSlider },
//studymaterial
{ path: "/cms/student_review/add", component: CreateStudentReview },
  { path: "/cms/student_review/:id", component: EditStudentReview },
{ path: "/cms/student_review", component: StudentReview },
//student rating
{ path: "/cms/study_material/add", component: CreateStudyMaterial },
  { path: "/cms/study_material/:id", component: EditStudyMaterial },
{ path: "/cms/study_material", component: StudyMaterial },
//WHATS NEW
{ path: "/cms/whats_new/add", component: CreateWhatsNew },
  { path: "/cms/whats_new/:id", component: EditWhatsNew },
{ path: "/cms/whats_new", component: WhatsNew },
  //Info Cards
  ...
  { path: "/cms/stats", component: Stats },
    //Stats
    { path: "/cms/bell_notification/add", component: CreateNotification },
    // { path: "/cms/stats/:id", component: EditStat },
    { path: "/cms/bell_notification", component: Notification },
  ...
  {
    path: "/cms/self_study_section",
    component: SelfStudy,
  },
  
  {
    path: "/cms/live_classess",
    component: LiveClassess,
  },
  {
    path: "/cms/quiz_bank",
    component: QuizBank,
  ...
  {
    path: "/cms/revission_test",
    component: RevissionTest,
  },
  {
    path: "/cms/Q&A",
    component: QA,
  ...
  {
    path: "/cms/study_plans",
    component: StudyPLans,
  },
  {
    path: "/cms/revision_notes",
    component: RivisionNotes,
  },
  {
    path: "/cms/access_student",
    component: AccessStudent,
  },
  
  {
    path: "/cms/unbeatable_prices",
    component: UnbeatablePrices,
  },
   {
    path: "/cms/student_stats",
